...
export default function Lateral2() {
    return (
    <>
                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            <div class="sb-sidenav-menu-heading ">Acciones</div>
                                <a class="nav-link text-light" href="/estudianteCreaSoli">
                                ...
                                <a class="nav-link text-light pb-3" href="/estudianteVeEstadoSolicitud">
                                    <div class="sb-nav-link-icon">
                                ...
                                <a class="nav-link text-light" href="/estudianteVeHistorial">
                                    <div class="sb-nav-link-icon">
